...
# On hérite de tf.keras.Model pour une gestion plus robuste des variables
class Policy(tf.keras.Model):
    ...
    # La méthode call définit le forward pass
    def call(self, inputs, with_sigmoid=True):
        # On sépare les entrées pour plus de clarté
        history, mask = inputs
        ...
        # Pas besoin d'utiliser self.masking(h) directement ici, le masque est passé au LSTM
